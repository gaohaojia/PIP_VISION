...
class YoLov5TRT(object):
    ...
    def infer(self, input_image_path):
        ...
        try:
            ...
            print("1144444444444444444444444444444444444444444444")
...
# position = -np.matrix(rotM).T * np.matrix(tvec)
            ...
            try:
                ...
                plot_one_box(box,
                             image_raw,
                             label = "{}:{:.2f}".format(
                                 categories[int(result_classid[mindex])], result_scores[mindex]
                             ),
                        )
            except:
                    '''666'''
...
if __name__ == "__main__":
    ...
    parser.add_argument('--engine', nargs='+', type=str, default="/home/pip-2/RM/tensorrtx-master/yolov5/build/best.engine", help='.engine path(s)')
    parser.add_argument('--save', type=int, default=0, help='save?')
    opt = parser.parse_args()
    PLUGIN_LIBRARY = "/home/pip-2/RM/tensorrtx-master/yolov5/build/libmyplugins.so"
    ...
    categories = ["armor1red", "armor3red", "armor4red", "armor7red", "armor1blue", "armor3blue", "armor4blue",
                  "armor7blue", "armor1grey", "armor3grey", "armor4grey", "armor7grey"]
